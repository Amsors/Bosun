...
// AgentSessionReconciler reconciles a AgentSession object
type AgentSessionReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=bosun.io,resources=agentsessions,verbs=get;list;watch;create;update;patch;delete
...
// Reconcile reserves the controller boundary frozen in T0.3. Workload
// provisioning is implemented by T1.4.
