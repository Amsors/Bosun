...
// +kubebuilder:rbac:groups=bosun.io,resources=userenvironments,verbs=get;list;watch;create;update;patch;delete
...
// Reconcile reserves the controller boundary frozen in T0.3. Resource
// provisioning is implemented by T1.2.
