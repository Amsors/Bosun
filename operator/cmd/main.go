...
import (
	...
	"github.com/Amsors/Bosun/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(bosunv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.UserEnvironmentReconciler{
